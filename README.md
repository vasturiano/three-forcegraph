...
| <b>nodeOpacity</b>([<i>num</i> or <i>fn</i>]) | Node object accessor function or attribute for nodes sphere opacity, between [0,1]. | 0.75   |
...
| <b>linkOpacity</b>([<i>num</i> or <i>fn</i>]) | Node object accessor function or attribute for line opacity of all the links, between [0,1]. | 0.2 |
